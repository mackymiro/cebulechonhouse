...
class OrderNowChineseKitchenAlaCarte extends Component
{
    public $isOpen = 0;
    ...
    public function updateOrder($id){
        ...
        return $this->redirect('/order-now/chinese-kitchen/ala-carte', navigate: true);
    ...
    public function render(){
        ...
        return view('livewire.order-now-chinese-kitchen-ala-carte', [
            'items'=>$items, 
            'allOrders'=>$allOrders, 
            'auth'=>$auth, 
            'authId'=>$authId,
