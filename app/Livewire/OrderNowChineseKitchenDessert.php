...
class OrderNowChineseKitchenDessert extends Component
{
    public $isOpen = 0;
    ...
    public function updateOrder($id){
        ...
        return $this->redirect('/order-now/chinese-kitchen/desserts', navigate: true);
    ...
    public function render(){
        ...
        return view('livewire.order-now-chinese-kitchen-dessert', [
            'items'=>$items, 
            'allOrders'=>$allOrders, 
            'auth'=>$auth, 
            'authId'=>$authId,
